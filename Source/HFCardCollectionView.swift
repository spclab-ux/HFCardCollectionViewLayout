...
class HFCardCollectionView: UICollectionView {
    ...
    override open func addGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        if let collectionViewLayout = self.collectionViewLayout as? HFCardCollectionViewLayout {
            ...
            // Prevent default behaviour of 'installsStandardGestureForInteractiveMovement = true'
    ...
    /// - Parameter animated: true to animate the transition at a constant velocity to the new offset, false
